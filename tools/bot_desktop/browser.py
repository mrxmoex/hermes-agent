...
def _append_this_jar_children_and_grandchildren(
    ...
    leftover parent leftover parent leftover parent leftover parent leftover
    parent leftover parent leftover parent leftover parent leftover parent leftover parent leftover parent
    that does not name this jar stays 231.
    ...
    """
    # Finding 232: twenty-eight leftover unique leftover parent leftover children
    # hops reach leftover daemon leftover children (chrome).
    frontier = [parent]
    for _hop in range(28):
        nxt: list[int] = []
        for pid in frontier:
            try:
