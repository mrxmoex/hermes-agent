...
def test_leftover_supervisor_parent_great_devtools_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    (tmp_path / "dock-cdp-port").write_text("18888\n", encoding="utf-8")
    assert browser._this_jar_holder_pids(40141, str(tmp_path)) == {
        leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill, leftover_cri,
    }
    assert browser._this_jar_holder_pids(18888, str(tmp_path)) == {leftover_py, 4240}
    assert browser._this_jar_holder_pids(9333, str(tmp_path)) == {4240, 4241, 4245}
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggreat_devtools_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    (tmp_path / "dock-cdp-port").write_text("18888\n", encoding="utf-8")
    assert browser._this_jar_holder_pids(40141, str(tmp_path)) == {
        leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill, leftover_cri,
    }
    assert browser._this_jar_holder_pids(18888, str(tmp_path)) == {leftover_py, 4240}
    assert browser._this_jar_holder_pids(9333, str(tmp_path)) == {4240, 4241, 4245}
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggreat_devtools_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    (tmp_path / "dock-cdp-port").write_text("18888\n", encoding="utf-8")
    assert browser._this_jar_holder_pids(40141, str(tmp_path)) == {
        leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill, leftover_cri,
    }
    assert browser._this_jar_holder_pids(18888, str(tmp_path)) == {leftover_py, 4240}
    assert browser._this_jar_holder_pids(9333, str(tmp_path)) == {4240, 4241, 4245}
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggreat_devtools_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    (tmp_path / "dock-cdp-port").write_text("18888\n", encoding="utf-8")
    assert browser._this_jar_holder_pids(40141, str(tmp_path)) == {
        leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill, leftover_cri,
    }
    assert browser._this_jar_holder_pids(18888, str(tmp_path)) == {leftover_py, 4240}
    assert browser._this_jar_holder_pids(9333, str(tmp_path)) == {4240, 4241, 4245}
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggggreat_devtools_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    (tmp_path / "dock-cdp-port").write_text("18888\n", encoding="utf-8")
    assert browser._this_jar_holder_pids(40141, str(tmp_path)) == {
        leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill, leftover_cri,
    }
    assert browser._this_jar_holder_pids(18888, str(tmp_path)) == {leftover_py, 4240}
    assert browser._this_jar_holder_pids(9333, str(tmp_path)) == {4240, 4241, 4245}
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggreat_devtools_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    (tmp_path / "dock-cdp-port").write_text("18888\n", encoding="utf-8")
    assert browser._this_jar_holder_pids(40141, str(tmp_path)) == {
        leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill, leftover_cri,
    }
    assert browser._this_jar_holder_pids(18888, str(tmp_path)) == {leftover_py, 4240}
    assert browser._this_jar_holder_pids(9333, str(tmp_path)) == {4240, 4241, 4245}
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    (tmp_path / "dock-cdp-port").write_text("18888\n", encoding="utf-8")
    assert browser._this_jar_holder_pids(40141, str(tmp_path)) == {
        leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill, leftover_cri,
    }
    assert browser._this_jar_holder_pids(18888, str(tmp_path)) == {leftover_py, 4240}
    assert browser._this_jar_holder_pids(9333, str(tmp_path)) == {4240, 4241, 4245}
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 217.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    (tmp_path / "dock-cdp-port").write_text("18888\n", encoding="utf-8")
    assert browser._this_jar_holder_pids(40141, str(tmp_path)) == {
        leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill, leftover_cri,
    }
    assert browser._this_jar_holder_pids(18888, str(tmp_path)) == {leftover_py, 4240}
    assert browser._this_jar_holder_pids(9333, str(tmp_path)) == {4240, 4241, 4245}
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 218.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 219.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 220.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
...
def test_leftover_supervisor_parent_gggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 221.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 222.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 223.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 224.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 225.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggggggggggggggreat, leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 226.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggggggggggggggggreat, leftover_ggggggggggggggggreat, leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 227.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggggggggggggggggreat, leftover_gggggggggggggggggreat, leftover_ggggggggggggggggreat, leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 228.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggggggggggggggggggreat, leftover_ggggggggggggggggggreat, leftover_gggggggggggggggggreat, leftover_ggggggggggggggggreat, leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggggggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 229.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggggggggggggggggggreat, leftover_gggggggggggggggggggreat, leftover_ggggggggggggggggggreat, leftover_gggggggggggggggggreat, leftover_ggggggggggggggggreat, leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 230.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggggggggggggggggggggreat, leftover_ggggggggggggggggggggreat, leftover_gggggggggggggggggggreat, leftover_ggggggggggggggggggreat, leftover_gggggggggggggggggreat, leftover_ggggggggggggggggreat, leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggggggggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 231.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggggggggggggggggggggreat, leftover_gggggggggggggggggggggreat, leftover_ggggggggggggggggggggreat, leftover_gggggggggggggggggggreat, leftover_ggggggggggggggggggreat, leftover_gggggggggggggggggreat, leftover_ggggggggggggggggreat, leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggggggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 232.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggggggggggggggggggggggreat, leftover_ggggggggggggggggggggggreat, leftover_gggggggggggggggggggggreat, leftover_ggggggggggggggggggggreat, leftover_gggggggggggggggggggreat, leftover_ggggggggggggggggggreat, leftover_gggggggggggggggggreat, leftover_ggggggggggggggggreat, leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_gggggggggggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 233.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_ggggggggggggggggggggggggreat, leftover_gggggggggggggggggggggggreat, leftover_ggggggggggggggggggggggreat, leftover_gggggggggggggggggggggreat, leftover_ggggggggggggggggggggreat, leftover_gggggggggggggggggggreat, leftover_ggggggggggggggggggreat, leftover_gggggggggggggggggreat, leftover_ggggggggggggggggreat, leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
...
def test_leftover_supervisor_parent_ggggggggggggggggggggggggggreat_devtools_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_great_grandchild_persist_does_not_hide_sibling_chrome(
    ...
    leftover children, not a leftover-holder leftover grandparent walk
    of leftover fill. Leftover supervisor leftover parent leftover
    parent leftover parent that does not name this jar stays 234.
    Leftover python that inherited both leftover persist and chrome's
    CDP stays 85. Leftover-only leftover supervisor leftover parent
    leftover parent leftover supervisor plus leftover supervisor leftover
    parent leftover supervisor plus leftover supervisor plus leftover
    ...
    monkeypatch.setattr(
        browser, "_loopback_listen_ports_for_pid",
        lambda pid: {40141, 18888} if pid == leftover_cri else (
            {40141} if pid in {leftover_gggggggggggggggggggggggggreat, leftover_ggggggggggggggggggggggggreat, leftover_gggggggggggggggggggggggreat, leftover_ggggggggggggggggggggggreat, leftover_gggggggggggggggggggggreat, leftover_ggggggggggggggggggggreat, leftover_gggggggggggggggggggreat, leftover_ggggggggggggggggggreat, leftover_gggggggggggggggggreat, leftover_ggggggggggggggggreat, leftover_gggggggggggggggreat, leftover_ggggggggggggggreat, leftover_gggggggggggggreat, leftover_ggggggggggggreat, leftover_gggggggggggreat, leftover_ggggggggggreat, leftover_gggggggggreat, leftover_ggggggggreat, leftover_gggggggreat, leftover_ggggggreat, leftover_gggggreat, leftover_ggggreat, leftover_gggreat, leftover_ggreat, leftover_great, leftover_grand, leftover_parent, leftover_root, leftover_sup, 4300, leftover_fill} else (
                {18888} if pid == leftover_py else set()
            )
        ),
    )
